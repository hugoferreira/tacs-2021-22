 ...
 *
 * For a Live Programming experience, use the Quokka plugin (https://quokkajs.com) 
...
sin.reduce((acc, a) => acc + a, '-> ') //?
z.reduce((acc, a) => acc * a, 1) //?
a.reduce((acc, a) => acc + a, 0) //?
...
b.reduce((acc, e) => (e % 2 == 0) ? acc.concat(e) : acc, Array()) //?
b.filter(e => (e % 2 == 0)) //?
b.map(e => e + 2) //?
...
const sum = (as) => fold(as, 0)((acc, e) => acc + e)
...
const forall = (iterable) => (f) =>
    fold(iterable, true)((acc, e) => (f(e) ? true : false));


forall([1, 2, 3])(e => e < 4) === true //?
forall([1, 2, 3])(e => e > 4) //?
forall([1, 2, 3, 5])(e => e > 4) //?
